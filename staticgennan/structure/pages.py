...
from staticgennan.structure.toc import get_toc
from staticgennan.utils import meta, get_markdown_title, warning_filter, parser
...
class Page:
    ...
    def render(self, config, files):
        ...
        self.content = parser.parseString(self.markdown, config, self.file.name)
