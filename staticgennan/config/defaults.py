from staticgennan.config import config_options
...
DEFAULT_SCHEMA = (
    ...
    # Reserved for internal use, stores the staticgennan.yml config file.
    ...
    # The staticgennan theme for the documentation.
    ('theme', config_options.Theme(default='staticgennan')),
    ...
    # this should look like, ['UA-27795084-5', 'staticgennan.org']
    ...
    # enabling strict mode causes staticgennan to stop the build when a problem is
    ...
    # staticgennan itself. A good example here would be including the current
    # project version.
