...
from staticgennan import __version__                            # noqa: E402
from staticgennan import utils                                  # noqa: E402
from staticgennan import exceptions                             # noqa: E402
from staticgennan import config                                 # noqa: E402
from staticgennan.commands import build, gh_deploy, new, serve  # noqa: E402
...
class State:
    ...
    def __init__(self, log_name='staticgennan', level=logging.INFO):
...
config_help = "Provide a specific staticgennan config"
dev_addr_help = ("IP address and port to serve documentation locally (default: "
                 "localhost:8000)")
strict_help = ("Enable strict mode. This will cause staticgennan to abort the build "
               "on any warnings.")
...
commit_message_help = ("A commit message to use when committing to the "
                       "Github Pages remote branch. Commit {sha} and staticgennan {version} are available as expansions")
...
ignore_version_help = "Ignore check that build is not being deployed with an older version of staticgennan."
...
def cli():
    """
    staticgennan - Project documentation with Markdown.
    """
...
def build_command(clean, **kwargs):
    """Build the staticgennan documentation"""
...
def new_command(project_directory):
    """Create a new staticgennan project"""
