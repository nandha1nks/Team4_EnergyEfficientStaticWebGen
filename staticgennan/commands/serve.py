...
from staticgennan.commands.build import build
from staticgennan.config import load_config
...
def _init_asyncio_patch():
    ...
    As Tornado has decided to leave this to users to set, staticgennan needs
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the staticgennan development server
    ...
    # string is returned. And it makes staticgennan temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='staticgennan_')
