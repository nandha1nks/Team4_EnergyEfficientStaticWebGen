"""
Implements the plugin API for staticgennan.
...
from staticgennan.config.base import Config


log = logging.getLogger('staticgennan.plugins')
...
def get_plugins():
    ...
    plugins = pkg_resources.iter_entry_points(group='staticgennan.plugins')
