...
from staticgennan.utils import filters
from staticgennan.config.base import ValidationError
...
class Theme:
    ...
    def __init__(self, name=None, **user_config):
        ...
        # staticgennan provided static templates are always included
        package_dir = os.path.abspath(os.path.dirname(__file__))
        staticgennan_templates = os.path.join(package_dir, 'templates')
        self.static_templates = set(os.listdir(staticgennan_templates))
        ...
        # Include templates provided directly by staticgennan (outside any theme)
        self.dirs.append(staticgennan_templates)
    ...
    def _load_theme_config(self, name):
        ...
        try:
            file_path = os.path.join(theme_dir, 'staticgennan_theme.yml')
